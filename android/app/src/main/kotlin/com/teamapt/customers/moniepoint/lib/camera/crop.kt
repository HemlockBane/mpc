 ...
 */
fun Bitmap.crop(crop: Rect, matrix: Matrix? = null): Bitmap {
    ...
    return Bitmap.createBitmap(this, crop.left, crop.top, crop.width(), crop.height(), matrix, true)
}

fun Bitmap.rotate(degrees: Float): Bitmap {
    return Bitmap.createBitmap(this, 0, 0, this.width, this.height, Matrix().apply { setRotate(degrees) }, true)
}
