...
abstract class AirtimeDao extends MoniepointDao<AirtimeTransaction> {
  @Query("SELECT * FROM airtime_transactions WHERE (creationTimeStamp BETWEEN :startDate AND :endDate) ORDER BY creationTimeStamp DESC LIMIT :limit OFFSET :myOffset")
  Stream<List<AirtimeTransaction>> getAirtimeTransactions(int startDate, int endDate, int myOffset, int limit);
