...
class AirtimePinDialog extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _AirtimePinDialog();
...
class _AirtimePinDialog extends TransactionPinDialogState<AirtimePinDialog> {
                      ...
                      Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(
                                      "${viewModel.beneficiary?.getBeneficiaryProviderName()}",
                                      style: TextStyle(
                                          color: Colors.solidDarkBlue,
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold
  ...
  PaymentViewModel getViewModel() {
    return Provider.of<AirtimeViewModel>(context, listen: false);
  }
