...
class SingleCardViewModel extends BaseViewModel {
  ...
  Stream<Resource<List<Card>>> getCards() {
    ...
    //   Card(id: 0,maskedPan: "514360******4198", expiryDate: "23/03", blocked: false, nameOnCard: "AAAAA Okeke", isActivated: true),
    //   Card(id: 1,maskedPan: "506099******4323", expiryDate: "23/03", blocked: false, nameOnCard: "AAAAA Okeke", isActivated: false),
    //   Card(id: 2,maskedPan: "406099******4323", expiryDate: "23/03", blocked: true, nameOnCard: "Ebun Oluwa", isActivated: true),
    // ]));
