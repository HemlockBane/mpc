...
class DashboardRefreshIndicator extends StatefulWidget {
  ...
  @override
  _DashboardRefreshIndicatorState createState() => _DashboardRefreshIndicatorState();
}

class _DashboardRefreshIndicatorState extends State<DashboardRefreshIndicator> with SingleTickerProviderStateMixin {
          ...
          children: <Widget>[
              ...
              builder: (context, _) {
                ...
                return Container(
                  child: SvgPicture.asset(
                      ...
                      fit: BoxFit.fill,
                      color: Colors.primaryColor.withOpacity(0.8)
                  ),
            ...
            AnimatedBuilder(
              ...
              builder: (BuildContext context, Widget? _) {
                ...
                if(!showLoadingIndicator ) return SizedBox();
