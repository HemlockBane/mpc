...
class InstitutionViewModel extends BaseViewModel {
  ...
  List<AccountProvider> sortAndRankWithAccountNumber(List<AccountProvider> accountProviders, String accountNumber) {
    ...
    final List<AccountProvider> sortedList = List.of(accountProviders);
    ...
    if (matchingCodes.contains("950515")) {
      insertionSort(sortedList, compare: (AccountProvider a, AccountProvider b) {
        return (a.bankCode != "950515" && b.bankCode == "950515")
            ? 1 : (a.bankCode == "950515" && b.bankCode != "950515")
            ? -1 : 0;
      });
    }
