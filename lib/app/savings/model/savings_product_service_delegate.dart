...
class SavingsProductServiceDelegate with NetworkResource {
  ...
  Future<FlexSaving?> getSingleFlexSaving(int flexSavingId){
    return _flexSavingsDao.getFlexSavingById(flexSavingId);
  }
  ...
  Stream<Resource<FlexWithdrawalCount>> getFreeWithdrawalCount() {
    return networkBoundResource(
        fetchFromLocal: () {
