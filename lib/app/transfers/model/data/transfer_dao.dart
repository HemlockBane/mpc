...
abstract class TransferDao extends MoniepointDao<SingleTransferTransaction> {
    ...
    @Query("SELECT * FROM transfer_transactions WHERE (dateAdded BETWEEN :startDate AND :endDate) ORDER BY dateAdded DESC LIMIT :limit OFFSET :offset")
    Stream<List<SingleTransferTransaction>> getSingleTransferTransactions(int startDate, int endDate, int offset, int limit);
