...
class TransferPinDialog extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _TransferPinDialog();
...
class _TransferPinDialog extends TransactionPinDialogState<TransferPinDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final fee = viewModel.getTransferFee();
  ...
  PaymentViewModel getViewModel() {
    return Provider.of<TransferViewModel>(context, listen: false);
  }
