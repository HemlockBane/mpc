...
class CustomSwipeCard extends StatefulWidget {
  ...
  @override
  State createState() => _TinderSwapCardState();
...
class _TinderSwapCardState extends State<CustomSwipeCard> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant CustomSwipeCard oldWidget) {
    ...
    _animationController.addStatusListener((AnimationStatus status) {
      ...
      if (status == AnimationStatus.completed) {
        ...
        if (widget.swipeCompleteCallback != null)
          widget.swipeCompleteCallback?.call(orientation, index);
