...
class MoniepointAppMessenger extends StatefulWidget {
  ...
  static MoniepointAppMessengerState? maybeOf(BuildContext context) {
    final _MoniepointAppMessengerScope? scope = context.dependOnInheritedWidgetOfExactType<_MoniepointAppMessengerScope>();
...
class MoniepointAppMessengerState extends State<MoniepointAppMessenger> {
  ...
  void register(MoniepointScaffoldState scaffoldState) {
    _moniepointScaffolds.add(scaffoldState);
  ...
  void unregister(MoniepointScaffoldState scaffoldState) {
    _moniepointScaffolds.remove(scaffoldState);
  }
...
class MoniepointScaffold extends StatefulWidget{
  ...
  @override
  State<StatefulWidget> createState() => MoniepointScaffoldState();
...
class MoniepointScaffoldState extends State<MoniepointScaffold> with TickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    final MoniepointAppMessengerState? _currentMoniepointMessenger = MoniepointAppMessenger.maybeOf(context);
    if(_moniepointAppMessenger != null
        && (_currentMoniepointMessenger == null || _moniepointAppMessenger != _currentMoniepointMessenger))  {
      _moniepointAppMessenger?.unregister(this);
    }
    _moniepointAppMessenger = _currentMoniepointMessenger;
    _moniepointAppMessenger?.register(this);
